...
class Light:
    ...
    def run(self, matrix_, return_tuple_shape: bool = False):
...
for d in range( total + 1):
    ...
    m11, m12, m21, m22 = ReflectanceRT.M()
    ...
    R_Lambda, T_Lambda = ReflectanceRT.run(TransPose_Matrix)
...
time.sleep(3)
print("\n\n Please wait,, while we are setting up the plots !\n\n")
time.sleep(2)
print(" Do not Forget to close each Figure after seen it, to another one can start runnig!")
...
print(" All the Plots generated from this script are successfully saved in -->> output/ <<-- Folder")